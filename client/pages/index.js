  ...
  const deleteTask = key => async () => {
    ...
    try{
      ...
      if(ethereum){
        ...
        console.log("sucessfully deleted", deleteTaskTx)
  ...
  return (
    <div className='bg-[#97b5fe] h-screen w-screen flex justify-center py-6'>
      {!isUserLoggedIn ? <ConnectWalletButton connectWallet={connectWallet} /> :
        correctNetwork ? <TodoList tasks = {tasks} setInput = {setInput} addTask = {addTask} imput={input} deleteTask = {deleteTask} currentAccount={currentAccount} /> : <WrongNetworkMessage />}
    </div>
  )
}
